...
The demo application builds upon the one used in the [DevOps Docker](https://github.com/sidpalas/devops-directive-docker-course/tree/main/05-example-web-application).
